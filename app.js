...
const MOCK_NEWS_TEMPLATES = [
  ...
  },
  {
    id: 3,
    category: '증시',
    title: '코스피, 반도체 및 신재생 부문 동반 강세로 2,750선 탈환 성공',
    body: '외국인 투자자들의 대규모 매수세에 힘입어 코스피 지수가 전일 대비 1.5% 상승하며 2,750선을 넘어섰습니다. 특히 인공지능 기반 고대역폭 메모리(HBM) 관련주와 해외 청정 에너지 수주 소식이 증시 상승을 견인했습니다.',
    time: '오전 08:00'
  },
  {
    id: 4,
